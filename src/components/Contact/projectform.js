...
`.trim(),
    ...
    return (
        <FormDiv data-netlify="true" netlify-honeypot="bot-field" className="projectformBottom" id="project-form" name="project" method="post" onSubmit={handleSubmit(formSubmit)}>
            ...
            {/* <input type="email" placeholder="Email" {...register("email", { required: true, pattern: {value: /\S+@\S+\.\S+/, message: "Please enter a valid email address."} })}  className={errors.email ? 'labelErr' : ''}/>
            ...
            {errors.company && <span className="formErr">This field is required.</span>}
